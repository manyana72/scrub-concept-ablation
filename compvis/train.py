...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=['style', 'object', 'memorization','logo', "retain"],
...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, save_freq=50, clamp=True, increase_log_steps=True,
...
if __name__ == "__main__":
    ...
    elif opt.concept_type=='logo':
        opt.base=['configs/finetune_logo.yaml']
    elif opt.concept_type == 'retain':
        opt.base = ['configs/finetune_retain.yaml']
    else:
    ...
    try:
        ...
        if opt.retain_path is not None:
            config.data.params.train.params.retain_path = opt.retain_path
